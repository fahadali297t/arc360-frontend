  ...
  return (
    <section id="final-cta" className="py-24 px-6 bg-white">
      <div className="max-w-[1440px] mx-auto">
        <div className="relative bg-[#30364F] rounded-[3rem] overflow-hidden shadow-[0_50px_100px_-20px_rgba(48,54,79,0.3)] border border-white/10">
          ...
          <div className="relative z-10 p-12 lg:p-24 flex flex-col items-center text-center">
            ...
            <p className="text-white/60 text-lg md:text-xl max-w-2xl mb-12 leading-relaxed">
              Scale your creative output without the overhead. Join ARC360 and get your first designs delivered in as little as 24 hours.
            </p>
            <div className="flex flex-col sm:flex-row gap-6">
              ...
              <button 
                ...
                className="bg-white/5 border border-white/20 text-white px-12 py-5 rounded-2xl font-black text-xl hover:bg-white/10 transition-all"
              >
                View Pricing
              </button>
            </div>
